const dataTypes = () => {
  ...
  console.log(
    `Mathematically corrected result of 0.1 + 0.2 is ${+sumToFixed}.`
  );
  ...
  const chocolatePrice = parseFloat(
    prompt("Enter a price of one chocolate :", "EURO")
  );
  ...
  if (
    ...
    console.log(
      `Reversed number of ${+threeDigitNumber_1} is ${+reversedNumber}.`
    );
  } else {
    console.log("Please enter the correct numbers !");
  }
  ...
  if (
    ...
    console.log(
      `Reversed number of ${+threeDigitNumber_2} is ${+reversedNumber}.`
    );
  } else {
    console.log("Please enter the correct numbers !");
  }
