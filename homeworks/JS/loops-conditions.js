...
if (userAge === "" || userAge === null || userAge < 0 || isNaN(userAge)) {
...
const userNumber = prompt("Enter a number from 0 to 9:", 0);
...
// цикл гри
while (true) {
    // нове число серед відомого діапазону
    guess = Math.floor((min + max) / 2);

    let userInp = prompt(`Ваше число > ${guess}, < ${guess}, або = ${guess}? Введіть '>', '<', або '='.`);
